...
## Features
* The website is structured in 4 pages : `Readflix`, `Collections`, `Community`, `MyBookLog`.
...
#### Readflix
* The `Readflix` page features a slider with several hero image. The purpose of this hero image element is to give maximum impact when opening the website.
